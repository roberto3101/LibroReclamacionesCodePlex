...
// Test 10: Limpieza de HTML/XSS en los campos
    test('Debe manejar caracteres especiales en el detalle del reclamo', async () => {
        const reclamoXSS = {
            tipo_solicitud: 'RECLAMO',
            nombre_completo: 'Test Hacker',
            tipo_documento: 'DNI',
            numero_documento: '12345678',
            telefono: '987654321',
            email: 'hacker@test.com',
            tipo_bien: 'PRODUCTO',
            descripcion_bien: '<b>Producto</b>', // XSS de prueba
            fecha_incidente: '2026-01-20',
            detalle_reclamo: '<script>alert("xss")</script>', // XSS de prueba
            pedido_consumidor: 'Limpieza de tags',
            firma_digital: 'data:image/png;base64,iVBORw0KGgoAAAANS',
            acepta_terminos: true
        };
