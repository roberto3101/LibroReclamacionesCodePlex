...
interface Reclamo {
    ...
    nombre_admin_atendio: string | null; // Nuevo campo
}
                    ...
                    {reclamo.respuesta_empresa && (
                        <div className="bg-green-50 rounded-lg border border-green-200 p-6 w-full">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="border-t border-green-200 pt-2 mt-2 flex justify-between items-center flex-wrap gap-2">
                                    {reclamo.respondido_por && (
                                        <p className="text-xs text-green-600">
                                            <span className="font-semibold">Email contacto:</span> {reclamo.respondido_por}
                                        </p>
                                    )}
                                    {reclamo.nombre_admin_atendio && (
                                        <div className="flex items-center gap-1 bg-white px-2 py-1 rounded border border-green-200 shadow-sm">
                                            ...
                                            <p className="text-xs text-green-700 font-bold">
                                                Atendido por: {reclamo.nombre_admin_atendio}
                                            </p>
                                        </div>
                                    )}
                                </div>
