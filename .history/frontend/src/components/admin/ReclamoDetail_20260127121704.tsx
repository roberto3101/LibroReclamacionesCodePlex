...
export default function ReclamoDetail({ id }: ReclamoDetailProps) {
	...
	const fetchReclamo = async () => {
		try {
			...
			const response = await fetch(`${API_URL}/api/reclamos/${id}`, {
						...
						<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
							...
							<div className="space-y-3">
								...
								<div>
									...
									<p className="text-gray-900 whitespace-pre-line">{reclamo.descripcion_bien}</p>
								</div>
							</div>
						</div>
						...
						<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
							...
							<div className="space-y-3">
								...
								<div>
									...
									<p className="text-gray-900 whitespace-pre-line">{reclamo.detalle_reclamo}</p>
								</div>
								<div>
									<p className="text-sm text-gray-600">Pedido del Consumidor</p>
									<p className="text-gray-900 whitespace-pre-line">{reclamo.pedido_consumidor}</p>
								</div>
							</div>
						</div>
							...
							<div className="bg-green-50 rounded-lg border border-green-200 p-6">
								...
								<div className="space-y-3">
									<div>
										...
										<p className="text-gray-900 whitespace-pre-line">{reclamo.respuesta_empresa}</p>
									</div>
									{reclamo.respondido_por && (
										<p className="text-xs text-green-600">Respondido por: {reclamo.respondido_por}</p>
									)}
								</div>
							</div>
						)}
