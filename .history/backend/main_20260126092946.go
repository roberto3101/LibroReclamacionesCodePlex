...
<tr>
<td class="header" style="background: #7c3aed; padding: 25px 20px; text-align: center;">
<h1 style="margin: 0; color: #ffffff; font-size: 22px; font-weight: bold;">💬 Nuevo Mensaje del Cliente</h1>
<p style="margin: 8px 0 0 0; color: #c4b5fd; font-size: 15px; word-break: break-all;">Reclamo: <strong style="color: #ffffff;">%s</strong></p>
</td>
</tr>
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%%" style="background-color: #eff6ff; border-radius: 6px; border: 1px solid #bfdbfe;">
<tr>
<td style="padding: 15px; word-break: break-word;">
<strong style="color: #1e40af;">👤 Cliente:</strong> <span style="display: inline-block; max-width: 100%%; word-wrap: break-word;">%s</span><br>
<strong style="color: #1e40af;">🆔 Documento:</strong> <span style="font-family: monospace;">%s</span><br>
<strong style="color: #1e40af;">📋 Código:</strong> <span style="font-family: monospace; word-break: break-all;">%s</span>
</td>
</tr>
</table>
</td>
...
<tr>
<td style="padding: 15px;">
<div style="word-break: break-word; overflow-wrap: break-word; white-space: pre-wrap; color: #1f2937; max-width: 100%%; line-height: 1.6;">%s</div>
</td>
</tr>
</table>
</td>
...
<a href="%s/seguimiento?codigo=%s" target="_blank" style="display: inline-block; padding: 12px 24px; background-color: #7c3aed; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 14px; word-break: keep-all;">
...
<tr>
<td class="footer" style="background-color: #1f2937; padding: 20px; text-align: center;">
