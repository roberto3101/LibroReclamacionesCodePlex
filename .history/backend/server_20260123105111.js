...
app.post('/api/reclamos', async (req, res) => {
    ...
    try {
        ...
        // Enviar emails de manera asíncrona
        enviarEmails(reclamo, {
            tipo_solicitud,
            nombre_completo,
            email,
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="field">
                            ...
                            <div>${tipo_bien}: ${descripcion_bien}</div>
                        </div>
                       ...
                       <div class="field">
                        ...
                        <div class="field">
                            ...
                            <div>
                                <a href="${process.env.FRONTEND_URL || 'http://localhost:3000'}/api/reclamos/${codigo_reclamo}/firma" 
                                   target="_blank" 
                ...
                <body>
                    <div class="container">
                        ...
                        <ul>
                            ...
                            <li><strong>Producto/Servicio:</strong> ${descripcion_bien}</li>
                        </ul>
                        
                        <div class="info">
                            <strong>ℹ️ Información Importante:</strong><br>
                            • Conserve este email como comprobante<br>
                            • Si no recibe respuesta en el plazo indicado, puede denunciar ante INDECOPI<br>
                            • INDECOPI: <a href="https://enlinea.indecopi.gob.pe/reclamavirtual/">Reclama Virtual</a><br>
                            • Teléfono Lima: 224-7777 | Provincias: 0-800-4-4040
                        </div>
                        
                        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; color: #6b7280; font-size: 12px;">
                            CODEPLEX SAC | RUC: 20XXXXXXXXX<br>
