...
CREATE INDEX idx_reclamos_atendido_por ON reclamos(atendido_por);
-- =============================================================================
-- TABLA: respuestas
...
-- Vista de seguimiento completo
-- Actualizada para incluir el administrador asignado (atendido_por)
CREATE OR REPLACE VIEW seguimiento_completo AS
SELECT 
    r.id,
    r.codigo_reclamo,
    r.tipo_solicitud,
