...
CREATE TABLE reclamos (
    ...
    razon_social VARCHAR(255) DEFAULT 'CODEPLEX SAC',
    ruc VARCHAR(11) DEFAULT '20XXXXXXXXX',
    direccion_proveedor TEXT DEFAULT 'AV. LOS PROCERES MZA. G3 LOTE. 11 - LIMA - LOS OLIVOS',
