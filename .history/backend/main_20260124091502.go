...
func enviarEmails(reclamo ReclamoCreado, req CrearReclamoRequest, tipoBien string) error {
	// PROTECCIÓN: Si el código está vacío (porque falló el registro), salimos para evitar Panic
	...
	if err := dialer.DialAndSend(m); err != nil {
		...
		// Continuamos para intentar enviar al cliente aunque falle el de soporte
	}

	log.Printf("📧 AceptaCopia=%v, Email=%s", req.AceptaCopia, req.Email)
...
func generarEmailSoporte(codigo, tipo, fechaLimite, nombre, email, telefono, ubicacion, tipoBien, descripcion, detalle string, monto float64) string {
	...
	montoHTML := ""
	if monto > 0 {
		montoHTML = fmt.Sprintf(`<tr><td style="padding: 8px 12px; font-weight: bold; color: #374151;">Monto Reclamado:</td><td style="padding: 8px 12px;">S/ %.2f</td></tr>`, monto)
	}
...
<body style="margin: 0; padding: 0; font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 1.6; color: #333333; background-color: #f3f4f6;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" style="background-color: #f3f4f6;">
<tr><td align="center" style="padding: 20px 10px;">
<table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; width: 100%%; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">

<!-- Header -->
<tr><td style="background: linear-gradient(135deg, #1e40af 0%%, #3b82f6 100%%); padding: 30px 20px; text-align: center;">
<h1 style="margin: 0; color: #ffffff; font-size: 24px;">📋 Nuevo %s</h1>
<p style="margin: 10px 0 0 0; color: #bfdbfe; font-size: 16px;">Código: <strong style="color: #ffffff;">%s</strong></p>
</td></tr>

<!-- Alerta Plazo -->
<tr><td style="padding: 20px;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" style="background-color: #fef2f2; border-left: 4px solid #dc2626; border-radius: 0 6px 6px 0;">
<tr><td style="padding: 15px;">
<strong style="color: #991b1b;">⚠️ PLAZO LEGAL:</strong>
...
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" style="background-color: #eff6ff; border-radius: 6px; border: 1px solid #bfdbfe;">
<tr><td style="padding: 12px 15px; border-bottom: 1px solid #bfdbfe; font-weight: bold; color: #1e40af;">👤 Datos del Consumidor</td></tr>
<tr><td style="padding: 15px;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0">
<tr><td style="padding: 4px 0;"><strong>Nombre:</strong> %s</td></tr>
<tr><td style="padding: 4px 0;"><strong>Email:</strong> <a href="mailto:%s" style="color: #1e40af;">%s</a></td></tr>
<tr><td style="padding: 4px 0;"><strong>Teléfono:</strong> <a href="tel:%s" style="color: #1e40af; font-weight: bold;">%s</a></td></tr>
<tr><td style="padding: 4px 0;"><strong>Ubicación:</strong> %s</td></tr>
</table>
</td></tr>
</table>
</td></tr>
...
<tr><td style="padding: 0 20px 20px 20px;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; border-radius: 6px; border: 1px solid #e5e7eb;">
<tr><td style="padding: 12px 15px; border-bottom: 1px solid #e5e7eb; font-weight: bold; color: #1e40af;">
📦 Bien Contratado: <span style="background-color: %s; color: %s; padding: 3px 10px; border-radius: 12px; font-size: 12px; margin-left: 8px;">%s</span>
</td></tr>
<tr><td style="padding: 15px;">
<div style="word-wrap: break-word; overflow-wrap: break-word; white-space: pre-wrap; max-width: 100%%;">%s</div>
%s
</td></tr>
</table>
</td></tr>
...
<!-- Detalle del Reclamo -->
<tr><td style="padding: 0 20px 20px 20px;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" style="background-color: #fff7ed; border-radius: 6px; border: 1px solid #fed7aa;">
<tr><td style="padding: 12px 15px; border-bottom: 1px solid #fed7aa; font-weight: bold; color: #c2410c;">📝 Detalle del %s</td></tr>
<tr><td style="padding: 15px;">
<div style="word-wrap: break-word; overflow-wrap: break-word; white-space: pre-wrap; max-width: 100%%; color: #1f2937;">%s</div>
</td></tr>
</table>
</td></tr>
...
<!-- Firma Digital -->
<tr><td style="padding: 0 20px 20px 20px;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" style="background-color: #f0fdf4; border-radius: 6px; border: 1px solid #86efac;">
<tr><td style="padding: 15px; text-align: center;">
<span style="color: #166534; font-weight: bold;">🖊️ Firma Digital:</span>
<a href="%s/api/reclamos/%s/firma" target="_blank" style="display: inline-block; margin-left: 10px; padding: 8px 16px; background-color: #1e40af; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold;">Ver Firma</a>
</td></tr>
</table>
</td></tr>

<!-- Footer -->
<tr><td style="background-color: #1f2937; padding: 20px; text-align: center;">
<p style="margin: 0; color: #9ca3af; font-size: 12px;">Este email fue generado automáticamente por el Libro de Reclamaciones Virtual</p>
<p style="margin: 8px 0 0 0; color: #6b7280; font-size: 11px;">CODEPLEX SAC | RUC: 20539782232</p>
</td></tr>
...
<!-- Header -->
<tr><td style="background: linear-gradient(135deg, #059669 0%%, #10b981 100%%); padding: 30px 20px; text-align: center;">
<h1 style="margin: 0; color: #ffffff; font-size: 24px;">✅ %s Registrado</h1>
<p style="margin: 10px 0 0 0; color: #a7f3d0; font-size: 18px; font-weight: bold;">%s</p>
</td></tr>

<!-- Mensaje de Bienvenida -->
<tr><td style="padding: 20px;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" style="background-color: #f0fdf4; border-left: 4px solid #10b981; border-radius: 0 6px 6px 0;">
<tr><td style="padding: 15px;">
...
<!-- Plazo de Respuesta -->
<tr><td style="padding: 0 20px 20px 20px;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" style="background-color: #eff6ff; border-left: 4px solid #3b82f6; border-radius: 0 6px 6px 0;">
<tr><td style="padding: 15px;">
<strong style="color: #1e40af;">📅 Plazo de Respuesta:</strong><br>
<span style="color: #1e3a8a;">Recibirá nuestra respuesta antes del <strong>%s</strong></span><br><br>
<span style="color: #6b7280; font-size: 13px;">Plazo legal: <strong>15 días hábiles</strong> (según D.S. 011-2011-PCM)</span>
</td></tr>
</table>
</td></tr>
...
<tr><td style="padding: 0 20px 20px 20px;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; border-radius: 6px; border: 1px solid #e5e7eb;">
<tr><td style="padding: 12px 15px; border-bottom: 1px solid #e5e7eb; font-weight: bold; color: #374151; background-color: #f9fafb;">📋 Resumen de su %s</td></tr>
<tr><td style="padding: 0;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0">
<tr style="border-bottom: 1px solid #f3f4f6;">
<td style="padding: 10px 15px; font-weight: bold; color: #6b7280; width: 140px;">Código:</td>
<td style="padding: 10px 15px; color: #1e40af; font-weight: bold;">%s</td>
</tr>
<tr style="border-bottom: 1px solid #f3f4f6; background-color: #f9fafb;">
<td style="padding: 10px 15px; font-weight: bold; color: #6b7280;">Fecha:</td>
<td style="padding: 10px 15px;">%s</td>
</tr>
<tr style="border-bottom: 1px solid #f3f4f6;">
<td style="padding: 10px 15px; font-weight: bold; color: #6b7280;">Tipo:</td>
<td style="padding: 10px 15px;">%s</td>
</tr>
<tr style="border-bottom: 1px solid #f3f4f6; background-color: #f9fafb;">
<td style="padding: 10px 15px; font-weight: bold; color: #6b7280;">Bien Contratado:</td>
<td style="padding: 10px 15px;">%s</td>
</tr>
<tr>
<td style="padding: 10px 15px; font-weight: bold; color: #6b7280; vertical-align: top;">Descripción:</td>
<td style="padding: 10px 15px; word-wrap: break-word; overflow-wrap: break-word; white-space: pre-wrap; max-width: 350px;">%s</td>
</tr>
</table>
</td></tr>
</table>
...
<tr><td style="padding: 0 20px 20px 20px;">
<table role="presentation" width="100%%" cellspacing="0" cellpadding="0" border="0" style="background-color: #fefce8; border-left: 4px solid #eab308; border-radius: 0 6px 6px 0;">
<tr><td style="padding: 15px;">
<strong style="color: #a16207;">ℹ️ Información Importante:</strong><br>
<span style="color: #854d0e;">• Conserve este email como comprobante de su solicitud</span>
</td></tr>
</table>
</td></tr>

<!-- Footer -->
<tr><td style="background-color: #1f2937; padding: 25px 20px; text-align: center;">
<p style="margin: 0; color: #ffffff; font-weight: bold; font-size: 14px;">CODEPLEX SAC</p>
<p style="margin: 5px 0; color: #9ca3af; font-size: 12px;">RUC: 20539782232</p>
<p style="margin: 10px 0 0 0; color: #6b7280; font-size: 11px;">AV. LOS PROCERES MZA. G3 LOTE. 11 - LIMA - LOS OLIVOS</p>
